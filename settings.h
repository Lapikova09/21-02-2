...
const unsigned int FONT_SIZE1 = 100;
const sf::Vector2f TEXT_POS{ 680.f,150.f };
const sf::Vector2f TEXT_POS1{ 680.f,600.f };
const sf::Vector2f LIFE1_POS{ 625.f,70.f };
const sf::Vector2f LIFE2_POS{ 675.f,70.f };
const sf::Vector2f LIFE3_POS{ 725.f,70.f };
const sf::Vector2f END_POS{ 2000.f,2000.f };
const sf::Vector2f BRICK_SIZE{ 40.f,40.f };
const sf::Vector2f BRICK1_POS{ 680.f,510.f };
const sf::Vector2f BRICK2_POS{ 680.f,470.f };
const sf::Vector2f BRICK3_POS{ 680.f,430.f };
const sf::Vector2f BRICK4_POS{ 680.f,390.f };
const sf::Vector2f BRICK5_POS{ 680.f,350.f };
